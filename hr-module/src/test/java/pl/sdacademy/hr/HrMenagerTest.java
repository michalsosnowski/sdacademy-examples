...
class HrMenagerTest {
	...
	void test09() {
		...
		//when
		List<Employee> sortedEmployees = hrMenager.sortByFirstNameWithBubble();
		//then
		assertThat(sortedEmployees).containsSequence(john, gorge);

	}

	@DisplayName("Should sort tree employees by first name descending ")
	@Test
	void test10() {
		//given
		Employee adam = hrMenager.create("Adam", "Plackowski", "11-04-1963");
		...
		List<Employee> sortedEmployees = hrMenager.sortByFirstNameWithBubble();
		//then
		assertThat(sortedEmployees).containsSequence(john, gorge, adam);

	}

	@DisplayName("Should sort all employees by first name descending ")
	@Test
	void test11() {
		//given
		Employee adam = hrMenager.create("Adam", "Plackowski", "11-04-1963");
		Employee gorge = hrMenager.create("Gorge", "Nowak", "17-04-1933");
		Employee john = hrMenager.create("John", "Nowak", "11-04-1963");
		Employee make = hrMenager.create("Make", "Nowak", "17-04-1933");


		//when
		List<Employee> sortedEmployees = hrMenager.sortByFirstNameWithBubble();
		//then
		assertThat(sortedEmployees).containsSequence(make, john, gorge, adam);
